...
namespace CrudTimesCS.view
{
    public partial class TelaPesquisarTime : Form
    {
        ...
        private void btnBuscarJogadores_Click(object sender, EventArgs e)
        {
            try
            {
                if (tbxCodigoJogadores.Text == "")
                {
                    MessageBox.Show("Digite um código válido.");
                    return;
                }
                ...
                {
                    Jogadores.CodJogadores = Convert.ToInt32(tbxCodigoJogadores.Text);
                }

                ManipulaJogadores manipula = new ManipulaJogadores();
                manipula.pesquisarCodigoJogadores();

                lblCodigoAtualJogadores.Text = Jogadores.CodJogadores.ToString();
                tbxFoneJogadores.Text = Jogadores.FoneJogadores;
                tbxNomeJogadores.Text = Jogadores.NomeJogadores;
                tbxEmailJogadores.Text = Jogadores.EmailJogadores;
        ...
        private void tbxNomeTimes_TextChanged(object sender, EventArgs e)
        {

        }

        private void btnAlterarJogadores_Click(object sender, EventArgs e)
        {

            if (lblCodigoAtualJogadores.Text == "")
            {
                MessageBox.Show("Digite um código válido!", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);

                lblCodigoAtualJogadores.Text = string.Empty;
                tbxNomeJogadores.Text = string.Empty;
                tbxEmailJogadores.Text = string.Empty;
                tbxFoneJogadores.Text = string.Empty;
                tbxCodigoJogadores.Text = string.Empty;
                
                return;
            }

            var resposta = MessageBox.Show("Deseja Fazer as alterações no time de código " + lblCodigoAtualJogadores.Text + " ? ", "Atenção!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

            if (resposta == DialogResult.Yes)
            {
                Jogadores.CodJogadores = Convert.ToInt32(lblCodigoAtualJogadores.Text);
        ...
        private void btnDeletarJogadores_Click(object sender, EventArgs e)
        {
            ...
            var resposta = MessageBox.Show("Deseja excluir o Jogadores" + tbxCodigoJogadores.Text + " ?",
                "Atenção", MessageBoxButtons.YesNo, MessageBoxIcon.Stop);
        ...
        private void tbxCodigoJogadores_TextChanged(object sender, EventArgs e)
        {
